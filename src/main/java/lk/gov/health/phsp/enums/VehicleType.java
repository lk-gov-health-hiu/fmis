...
public enum VehicleType {
    ...
    Ambulance("Ambulance", true, "rgba(255, 99, 132, 0.6)", 100.0),
    Bowser("Bowser", true, "rgba(54, 162, 235, 0.6)", 150.0),
    Bus("Bus", true, "rgba(255, 206, 86, 0.6)", 350.0),
    Cab("Cab", true, "rgba(75, 192, 192, 0.6)", 100.0),
    Car("Car", true, "rgba(153, 102, 255, 0.6)", 100.0),
    FoggingMachine("Fogging Machine", false, "rgba(255, 159, 64, 0.6)", 40.0),
    Generator("Generator", false, "rgba(199, 199, 199, 0.6)", 1200.0), // Example of a lighter shade for non-vehicle items
    ...
    Van("Van", true, "rgba(0, 128, 0, 0.6)", 100.0);
